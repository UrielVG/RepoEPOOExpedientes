<%-- 
    ...
    Created on : 13/04/2018, 06:09:47 PM
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="../control" method="post">
                                        <input type="hidden" name="pagina" value="altaMedicamento">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <p class="help-block">ej. Pfizer</p>
                                        </div>
                                        <div class="form-group">
                                            <label>Substancia</label>
                                            <input class="form-control" name="substancia">
                                            <p class="help-block">Ej. Paracetamol</p>
                                        </div>
